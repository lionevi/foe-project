...
namespace Foe.Common
{
    ...
    public static class SubjectGenerator
    {
        ...
        public static string ReplySubject(RequestType requestType, string catalog, string requestId, string userId)
        {

            return ("Re: " + catalog + " " + RequestSubject(requestType, requestId, userId));
