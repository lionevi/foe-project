...
namespace OpenPOP.POP3
{
	...
	public class POPClient
	{
		...
		public void Connect(string strHost,int intPort)
		{
            ...
            // Modified by Hugh Hall to support SSL
            if (IsUsingSsl)
            {
                // create an SSL stream
                stream = new SslStream(clientSocket.GetStream(), false);
...
/*		private string GetCommand(string input)
        ...
        // Added by Hugh Hall to support POP3 over SSL
        private bool isUsingSsl = false;
        private Stream stream;

        /// <summary>
        /// Enable or disable POP3 over SSL.
        /// </summary>
        /// <param name="enableSsl">Whether to enable POP3 over SSL</param>
        public bool IsUsingSsl
        {
            get { return isUsingSsl; }
            set { isUsingSsl = value; }
        }
	}
}
